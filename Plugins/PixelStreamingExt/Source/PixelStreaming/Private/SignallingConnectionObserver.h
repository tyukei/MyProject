...
namespace UE::PixelStreaming
{
	...
	public:
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////
		// PluginExt: START
		virtual void OnSignallingPlayerGoingAway(FPixelStreamingPlayerId PlayerId) override;
		virtual void OnSignallingSfuConnected() override;
		virtual void OnSignallingSfuDisconnected() override;
		virtual void OnSignallingAIConnected(FPixelStreamingPlayerId PlayerId, const FPixelStreamingPlayerConfig& PlayerConfig, bool bSendOffer) override;
		virtual void OnSignallingAIDisconnected(FPixelStreamingPlayerId PlayerId) override;
		// PluginExt: END
		////////////////////////////////////////////////////////////////////////////////////////////////
