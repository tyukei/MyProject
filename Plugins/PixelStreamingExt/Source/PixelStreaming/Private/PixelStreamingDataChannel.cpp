...
{
	/* PSExt add start */
	auto ret = TSharedPtr<FPixelStreamingDataChannel>(new FPixelStreamingDataChannel(Connection, SendStreamId, RecvStreamId));
	return ret->RecvChannel ? ret : nullptr;
	/* PSExt add end */
}
