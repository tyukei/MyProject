...
public:
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
	// PluginExt: START
	virtual void OnSignallingPlayerGoingAway(FPixelStreamingPlayerId PlayerId) = 0;
	virtual void OnSignallingSfuConnected() = 0;
	virtual void OnSignallingSfuDisconnected() = 0;
	virtual void OnSignallingAIConnected(FPixelStreamingPlayerId PlayerId, const FPixelStreamingPlayerConfig& PlayerConfig, bool bSendOffer) = 0;
	virtual void OnSignallingAIDisconnected(FPixelStreamingPlayerId PlayerId) = 0;
	// PluginExt: END
	////////////////////////////////////////////////////////////////////////////////////////////////
};
