...
public:
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
	// PluginExt: START
	virtual void SendDisconnectScene(const FString& SceneId, const FString& Reason){};

	virtual void SendStreamerDataChannelsFailed(FPixelStreamingPlayerId PlayerId, const int SendStreamId, const int RecvStreamId){};
	// PluginExt: END
	////////////////////////////////////////////////////////////////////////////////////////////////
};
