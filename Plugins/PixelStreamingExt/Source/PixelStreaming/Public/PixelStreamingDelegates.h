...
public:
	...
	// PluginExt: START
	// C++ Delegate
	DECLARE_MULTICAST_DELEGATE_TwoParams(FOnPlayerConnectedNative, FString, FPixelStreamingPlayerId);
	FOnPlayerConnectedNative OnPlayerConnectedNative;
	// C++ Delegate
	DECLARE_MULTICAST_DELEGATE_TwoParams(FOnPlayerDisconnectedNative, FString, FPixelStreamingPlayerId);
	FOnPlayerDisconnectedNative OnPlayerDisconnectedNative;
	// C++ Delegate
	DECLARE_MULTICAST_DELEGATE_TwoParams(FOnPlayerGoingAwayNative, FString, FPixelStreamingPlayerId);
	FOnPlayerGoingAwayNative OnPlayerGoingAwayNative;
	// PluginExt: END
	////////////////////////////////////////////////////////////////////////////////////////////////////////////
