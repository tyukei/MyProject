...
public:
	...
	//////////////////////////////////////////////////////////////////////////////
	// PluginExt: START
	// Handler の引数に PlayerId を引数に追加しました。
	/**
	 ...
	 */
	virtual void RegisterMessageHandler(const FString& MessageType, const TFunction<void(FString, FMemoryReader)>& Handler) = 0;
