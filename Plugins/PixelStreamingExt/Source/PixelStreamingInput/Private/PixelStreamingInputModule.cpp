...
namespace UE::PixelStreamingInput
{
	...
	void FPixelStreamingInputModule::PopulateProtocol()
	{
		...
		/////////////////////////////////////////////////////////////////////////////
		// PluginExt: START
		FPixelStreamingInputProtocol::ToStreamerProtocol.Add("ResetBroadcastTouchMoveList", FPixelStreamingInputMessage(130));
		FPixelStreamingInputProtocol::ToStreamerProtocol.Add("BroadcastTouchMoveList", FPixelStreamingInputMessage(131));
		// PluginExt: END
		/////////////////////////////////////////////////////////////////////////////
